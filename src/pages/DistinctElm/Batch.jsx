...
import { AddBusiness, AddIcCallRounded, Alarm, CallEnd, CallMissed, EmojiEmotions, HlsOffRounded, NotificationAdd, NotificationImportant, NotificationsActive, NotificationsOff, NotificationsPaused, PauseCircle, PhoneInTalk, RingVolume, SettingsPhone, } from '@mui/icons-material';
import './dialer.css';
...
function Batch({ elm }) {
    const [svgsArray, setsvgsArray] = useState([
        { icon: NotificationAdd, color: "rgba(220,91,183,1)" },
        { icon: PauseCircle, color: "rgba(149,149,255,1)" },
        { icon: NotificationsActive, color: "rgba(252,161,71,1)" },

        { icon: NotificationsOff, color: "rgb(98 98 107)" },
        { icon: NotificationImportant, color: "rgba(66,193,110,1)" },
