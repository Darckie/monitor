...
import { AddIcCallRounded, Alarm, Aod, CallEnd, CallMissed, EmojiEmotions, PhoneInTalk, PhonelinkRing, RingVolume, SettingsPhone, SpeakerPhone, StayPrimaryLandscape, Upcoming, UpcomingSharp, UpcomingTwoTone, } from '@mui/icons-material';
import './dialer.css';
...
function Dialer({ elm }) {
    ...
    const [svgsArray, setsvgsArray] = useState([
        { icon: Aod, color: "rgba(220,91,183,1)" },
        { icon: UpcomingTwoTone, color: "rgba(149,149,255,1)" },
        { icon: StayPrimaryLandscape, color: "rgba(252,161,71,1)" },
        { icon: PhonelinkRing, color: "rgba(66,193,110,1)" },
        { icon: SpeakerPhone, color: "rgb(98 98 107)" },
